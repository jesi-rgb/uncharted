...
export const xAxesContext = new Context<{ xKey: string, xScale: () => Scale<'linear'> }>(X_AXES_CONTEXT)
export const yAxesContext = new Context<{ yKey: string, yScale: () => Scale<'linear'> }>(Y_AXES_CONTEXT)
